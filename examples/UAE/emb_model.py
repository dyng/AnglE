...
class EmbModel(DRESModel):
    def __init__(
            self,
            model_name_or_path: str = None,
            angle_name_or_path: str = None,
        ...
        if angle_name_or_path is not None:
            print(f'load angle {angle_name_or_path}...')
        self.model = AutoModel.from_pretrained(angle_name_or_path or model_name_or_path)
